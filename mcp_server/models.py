...
class CertificateParameters(BaseModel):
    ...
    RegistrationID: str = Field(
        ..., description='Registration Number', examples=['BU/XXX/XXX/XXXXX/YEAR/X']
    )
...
class BtcerCertificatePostRequest(BaseModel):
...
class BtcerCertificatePostResponse(BaseModel):
...
class BtcerCertificatePostResponse1(BaseModel):
...
class BtcerCertificatePostResponse2(BaseModel):
...
class BtcerCertificatePostResponse3(BaseModel):
...
class BtcerCertificatePostResponse4(BaseModel):
...
class BtcerCertificatePostResponse5(BaseModel):
...
class BtcerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class DtcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class DtcerCertificatePostResponse(BaseModel):
...
class DtcerCertificatePostResponse1(BaseModel):
...
class DtcerCertificatePostResponse2(BaseModel):
...
class DtcerCertificatePostResponse3(BaseModel):
...
class DtcerCertificatePostResponse4(BaseModel):
...
class DtcerCertificatePostResponse5(BaseModel):
...
class DtcerCertificatePostResponse6(BaseModel):
...
class CertificateParameters2(BaseModel):
    ...
    DSN: str = Field(
        ...,
        description='DSN Number',
        examples=['For eg. 1234. Please enter number only'],
    )
...
class CertificateParameters3(BaseModel):
    ...
    DSNNo: str = Field(..., description='DSN No', examples=['7887'])
    Father: str = Field(
        ..., description='Father Name', examples=['First Name Last Name']
    )
...
class CertificateParameters4(BaseModel):
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
    DSN: str = Field(
...
class RacerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters4] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
    )
...
class CertificateParameters5(BaseModel):
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
    DSNNo: str = Field(..., description='DSN Number', examples=['2257331'])
    FatherName: str = Field(
        ..., description='Father Name', examples=['FirstName MiddleName LastName']
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    UID: str = Field(..., description='Aadhaar number', examples=['123412341234'])
...
class RscerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters5] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
    )
...
class CertificateParameters6(BaseModel):
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
    DSNNo: str = Field(..., description='DSN No', examples=['5592'])
    Father: str = Field(
        ..., description='Father Name', examples=['First Name Last Name']
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
...
class ShcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters6] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
    )
